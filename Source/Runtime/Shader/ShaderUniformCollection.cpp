...
void ShaderUniformCollection::ExtractUniforms(const NameSet& filteredUniforms)
{
    ...
    for (unsigned int i = 0; i < uniformCount; ++i)
    {
        ...
        else if (IsImageUniform(glType, image))
        {
            // Do nothing
        }
        else
...
bool ShaderUniformCollection::IsImageUniform(GLenum glType, TextureObject::Image& image)
{
    switch (glType)
    {
    case GL_IMAGE_1D:
        image = TextureObject::Image::Image1D;
        break;
    case GL_IMAGE_1D_ARRAY:
        image = TextureObject::Image::Image1DArray;
        break;
    case GL_IMAGE_2D:
        image = TextureObject::Image::Image2D;
        break;
    case GL_IMAGE_2D_ARRAY:
        image = TextureObject::Image::Image2DArray;
        break;
    case GL_IMAGE_2D_MULTISAMPLE:
        image = TextureObject::Image::Image2DMultisample;
        break;
    case GL_IMAGE_2D_MULTISAMPLE_ARRAY:
        image = TextureObject::Image::Image2DMultisampleArray;
        break;
    case GL_IMAGE_3D:
        image = TextureObject::Image::Image3D;
        break;
    case GL_IMAGE_CUBE:
        image = TextureObject::Image::ImageCube;
        break;
    case GL_IMAGE_CUBE_MAP_ARRAY:
        image = TextureObject::Image::ImageCubemapArray;
        break;
    default:
        return false;
    }
